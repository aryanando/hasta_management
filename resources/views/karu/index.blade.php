...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Karu</h1>
    ...
    <div class="card my-3 shadow" style="background-color: #9ee8b2;">
        ...
        <div class="card-body">
            <h6 class="card-subtitle mb-2 text-muted">Perbaikan Shift</h6>
            <p class="card-text">Kini hapus shift telah dapat digunakan.</p>
            <div class="d-flex justify-content-end">
                <p class="small">26/08/2024</p>
            </div>
        </div>
    </div>
    <div class="card my-3 shadow" style="background-color: #9ee8b2;">
